...
/**
 * This class provides android instrumentation testing for cucumber steps. 
 * This invokes only one activity through a cucumber scenario and 
 * you will then be able to manipulate your Activity directly.
 * </p>
...
public class ActivityInstrumentationSteps extends TestCase {
	...
	/**
	 * Wrapper for abstract class ActivityInstrumentationTestCase2 which is initialized only
	 * once during the one whole scenario through the steps classes.
	 */
